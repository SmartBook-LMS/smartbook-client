                    ...
                    <Box style={{ margin: 20, padding:30 }}>
                        <div className={classes.root}>
                            <Grid container spacing={3}>
                                ...
                                <Grid item xs={6}>
                                <Typography className={classes.value}>{`${account.username}`}</Typography>
                                </Grid>
                                <Grid item xs={6}>
                                <Typography className={classes.field}>NAME    |</Typography>
                                </Grid>
                                <Grid item xs={6}>
                                <Typography className={classes.value}>{`${account.firstName} ${account.lastName}`}</Typography>
                                </Grid>
                                <Grid item xs={6}>
                                <Typography className={classes.field}>BIRTHDATE    |</Typography>
                                </Grid>
                                <Grid item xs={6}>
                                <Typography className={classes.value}>{`${account.birthdate}`}</Typography>
                                </Grid>
                            </Grid>
                        </div>
                    </Box>
